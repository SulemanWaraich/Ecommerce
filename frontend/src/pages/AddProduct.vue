    ...
    >
      ...
      <div class="mb-4">
        ...
        <input
          ...
          accept="image/*"
          @change="handleImage"
          class="block border-1 p-2 text-center bg-gray-300 cursor-pointer"
        />
        <img
          v-if="previewUrl"
          :src="previewUrl"
          class="w-24 h-24 object-cover mt-2 rounded border"
        />
      </div>
      ...
      <button
        @click="resetForm"
        class="bg-red-600 hover:bg-green-700 text-white px-5 py-2 rounded mt-4"
      >
        Reset
      </button>
    </form>
